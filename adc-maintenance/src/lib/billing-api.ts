...
export const paymentApi = {
  ...
  generatePaymentLink: async (data: {
    ...
    const response = await api.post('/billing/payments/generate-link', data);
    return response.data;
  },
  ...
  generatePaymentQR: async (data: {
    ...
    console.log('Generating payment QR with data:', data);
    const response = await api.post('/billing/payments/generate-qr', data);
    return response.data;
  },
